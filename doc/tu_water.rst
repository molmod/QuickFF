...
*gaussian_wpart.h5*. We will construct a script (which we will give the name
...
are read from the dataset *wpart/he/charges* in the HDF5 file *guassian_wpart.h5*.

.. literalinclude:: ../share/tutorials/water/qff-derive.py
   :language: python
   :lines: 48-52

*scales* is list of 4 floats, representing the electrostatic scalings of 1-2, 
...
*Average=True* indicates that the set of charges are averaged over atom types.
